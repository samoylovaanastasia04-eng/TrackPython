def count_letters(text):
    ...
    letter_count = {}
    # Приводим текст к нижнему регистру и подсчитываем буквы
...
def calculate_frequency(letter_count):
    ...
    for letter, count in letter_count.items():
        # Вычисляем частоту и округляем до 2 знаков после запятой
...
# Распечатываем в столбик букву и её частоту в тексте с двумя знаками после запятой
